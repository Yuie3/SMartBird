...
constexpr Translation kTranslations[] = {
    ...
    {"player.repeat_off", "循環關閉", "Repeat off"},
    {"player.repeat_all_on", "循環全部", "Repeat all"},
    {"player.repeat_one_on", "單部循環", "Repeat one"},
    {"player.repeat_off_short", "關閉", "Off"},
    {"player.repeat_all", "全部", "All"},
    {"player.repeat_one", "單部", "One"},
    {"player.shuffle_on", "隨機播放", "Shuffle on"},
    {"player.shuffle_off", "取消隨機", "Shuffle off"},
