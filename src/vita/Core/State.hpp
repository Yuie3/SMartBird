...
extern BrowserForwardEntry gBrowserForwardHistory[kMaxBrowserHistory];
extern int gBrowserForwardHistoryCount;
extern HiddenItem gHiddenItems[kMaxHiddenItems];
extern int gHiddenItemCount;
extern int gBrowserSource;
extern int gUiFrame;
extern int gUiSnapListMotionFrame;
extern int gUiBackSwipeActive;
extern int gUiBackSwipeDirection;
extern float gUiBackSwipeProgress;
extern void* gNetMem;
...
extern int gPlayerPendingAction;
