...
BrowserForwardEntry gBrowserForwardHistory[kMaxBrowserHistory] = {};
int gBrowserForwardHistoryCount = 0;
HiddenItem gHiddenItems[kMaxHiddenItems] = {};
int gHiddenItemCount = 0;
int gBrowserSource = SourceSmb;
int gUiFrame = 0;
int gUiSnapListMotionFrame = -1;
int gUiBackSwipeActive = 0;
int gUiBackSwipeDirection = 0;
float gUiBackSwipeProgress = 0.0f;
...
int gPlayerPendingAction = PlayerPendingNone;
